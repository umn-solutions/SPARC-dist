...
_CurrentUser_initialized = new WeakMap, _CurrentUser_instances = new WeakSet, _CurrentUser_resolveGroup = async function _CurrentUser_resolveGroup(hierarchy, identities, siteApi) {
